...
export type SessionActions = IActionStartSessionSuccess | 
...
export const setFailureNumber =(failureNumber:number):IActionSetFailureRateNumber =>{
  return {
...
export const changeSessionFailureNumberSuccess = (error:any):IActionChangeErrorFailureSuccess =>{
  return {
...
export const changeSessionFailureNumberFailure = (id:any):IActionChangeErrorFailureFailure =>{
  return {
